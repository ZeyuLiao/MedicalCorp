...
public class MyEncounter extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButtonViewDia = new javax.swing.JButton();
        ...
        jButtonViewDia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/tijian.png"))); // NOI18N
        jButtonViewDia.setText("View Diagnosis");
        jButtonViewDia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonViewDiaActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jButtonViewDia, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jButtonViewDiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonViewDiaActionPerformed
        // TODO add your handling code here:
        int selectedIndex = jTableEncounter.getSelectedRow();
        if(selectedIndex < 0){
        ...
        int encounterId = Integer.parseInt(model.getValueAt(selectedIndex,0).toString());
        try {
            ViewDiagnosis vd = new ViewDiagnosis(eDao.getEncounterByEncounterId(encounterId).getDiagnosis());
            vd.setVisible(true);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }//GEN-LAST:event_jButtonViewDiaActionPerformed
    ...
    private javax.swing.JButton jButtonViewDia;
