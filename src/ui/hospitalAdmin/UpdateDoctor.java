...
public class UpdateDoctor extends javax.swing.JFrame {
    ...
    public UpdateDoctor(int doctorId) throws Exception {
        ...
        jTextFieldName.setText(d.getName());
        jTextFieldDepartment.setText(d.getDepartment());
        jTextFieldPhoneNumber.setText(d.getPhoneNumber());
        jComboBoxCHospital.setSelectedItem(d.getHospitalName());
        this.filepath = d.getPhotoAddress();
        ImageIcon img = new ImageIcon(d.getPhotoAddress());
